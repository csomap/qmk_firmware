...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] =
{
        ...
        //Mouse
        [_MOUSE] = LAYOUT(
            _______, _______, _______, _______, _______,         _______, _______, KC_MS_U, _______, KC_WH_U,
            _______, KC_BTN2, KC_NO,   KC_BTN1, _______,         _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_D,
        ...
        [_NAVIGATION] = LAYOUT(
            ...
            KC_END,  KC_LEFT, KC_DOWN, KC_RGHT, _______,          _______, KC_LGUI, KC_NO,   LCTL(KC_LALT), LCA(KC_LSFT),
            _______, _______, _______, KC_PGDN, _______,          _______, _______, _______, _______,       _______,
                                       _______, _______,          _______, _______
        ),
        //I3 navigation
        [_I3WM_NAV] = LAYOUT(
            _______, KC_I3_7, KC_I3_8, KC_I3_9, _______,           _______, _______, KC_I3_U, _______, _______,
            KC_LSFT, KC_I3_1, KC_I3_2, KC_I3_3, _______,           _______, KC_I3_L, KC_I3_D, KC_I3_R, _______,
            _______, KC_I3_4, KC_I3_5, KC_I3_6, _______,           _______, _______, _______, _______, _______,
                                       _______, KC_NO,                          _______, _______
        ),
        //I3 commands
        [_I3WM_CMD] = LAYOUT(
            KC_I3_LOCK_SCREEN,   _______,        KC_I3_SPT, _______,           KC_I3_FORCECLOSE,   _______, _______,       _______,       _______,      KC_I3_RELOAD_CONFIG,
